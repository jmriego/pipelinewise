FROM harbor.awscmhinfra.k8s.indeed.tech/dockerhub-proxy/library/python:3.7.7-slim-buster
...
ARG connectors=all
COPY . /app
COPY ./pipelinewise-target-bigquery /opt/pipelinewise/pipelinewise-target-bigquery
